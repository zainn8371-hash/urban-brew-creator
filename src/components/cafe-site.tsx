    ...
    <main className="overflow-x-hidden bg-background text-foreground">
      ...
      <section id="contact" className="scroll-mt-20 py-24 sm:py-32">
        <div className="mx-auto grid max-w-[1440px] gap-14 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:px-12"><div><p className="section-kicker">Lahore, Pakistan</p><h2 className="section-title">Find your way<br />to <em>Up Town.</em></h2><p className="mt-7 max-w-md leading-7 text-muted-foreground">Pull up a chair. We’re here for morning coffee, long lunches, and everything in between.</p><div className="mt-10 divide-y divide-border border-y border-border">
          ...
          <div className="relative min-h-[500px] overflow-hidden rounded-md bg-primary"><img src={heroImage} alt="Up Town Cafe in Johar Town, Lahore" width={1600} height={1200} loading="lazy" className="absolute inset-0 h-full w-full object-cover opacity-50" /><div className="absolute inset-0 grid place-items-center bg-map-overlay p-6 text-center text-primary-foreground"><div><span className="mx-auto grid size-16 place-items-center rounded-full bg-copper text-copper-foreground"><MapPin className="size-7" /></span><p className="mt-5 font-display text-3xl">Up Town Cafe</p><p className="mt-2 text-sm text-primary-foreground/70">{CONTACT.address}</p><Button asChild variant="outline" className="mt-6 border-primary-foreground/30 bg-transparent text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground"><a href="https://www.google.com/maps/search/?api=1&query=55%2C%20Block%20C1%20Block%20C%20Phase%201%20Johar%20Town%2C%20Lahore%2C%20Punjab%2054000%2C%20Pakistan" target="_blank" rel="noreferrer">Get directions <ArrowRight /></a></Button></div></div></div>
        </div>
      </section>
